...
if CheckMaxFreq==True:
    maxFreq = Checkvalid(Geometry,Order,alpha,inorout,mur,sig, sweepname)
    import sys
...
#print("Recomeneded max frequency is  ",maxFreq)
print("Time for the simulation:", time.time()-start_time)

...
### classes must reflect the ordering of Name_Order in Creator.py
...
### Name_Order as used in Creator.py
...
##dataset_path = r'DataSets/British-Coins-Updated-1p-2p/Coins-1000_Al_0.84_Sig_12.5'
##results_path = r'Results/British-Coins-Updated-1p-2p/Coins-1000_Al_0.84_Sig_12.5/Noise_5/LogisticRegression_Bayesian/Principal_Tr5_Te5'

###"US-Coins-PL-10Aug23/Coins-1000"
filenames = [r'MeasurementData/One_Cent.xlsx',
             r'MeasurementData/Dime.xlsx',
             r'MeasurementData/Nickel.xlsx',
             r'MeasurementData/Quarter.xlsx',
             r'MeasurementData/HalfDollar.xlsx']
#filenames = [r'MeasurementData/HalfDollar.xlsx']
### Name_Order as used in Creator.py
...
# paths for both loading (dataset_path) excel files, and the input data generated by Trainer.py (results_path)
#dataset_path = r'DataSets/US_Coin_PL/Coins-200_Al_0.84_Sig_12.5'
#results_path = r'Results/US_Coin_PL/Coins-200_Al_0.84_Sig_12.5/Noise_5/LogisticRegression_Bayesian/Principal_Tr5_Te5'
dataset_path = r'DataSets/US-Coins-PL-10Aug23/Coins-1000_Al_0.84_Sig_12.5'
results_path = r'Results/US-Coins-PL-10Aug23/Coins-1000_Al_0.84_Sig_12.5/Noise_5/LogisticRegression_Bayesian/Principal_Tr5_Te5'

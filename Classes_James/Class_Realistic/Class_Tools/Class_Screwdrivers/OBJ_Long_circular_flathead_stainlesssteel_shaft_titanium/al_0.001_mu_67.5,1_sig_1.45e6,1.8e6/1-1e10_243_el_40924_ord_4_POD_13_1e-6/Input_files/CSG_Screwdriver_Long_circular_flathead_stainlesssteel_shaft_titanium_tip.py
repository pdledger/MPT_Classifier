...
geo = CSGeometry(r'GeoFiles/long_circular_flathead.geo')
...
nmesh.Save(r'VolFiles/CSG_Screwdriver_Long_circular_flathead_stainlesssteel_shaft_titanium_tip.vol')

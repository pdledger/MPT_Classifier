...
geo = CSGeometry(r'GeoFiles/Short_circular_flathead.geo')
...
nmesh.Save(r'VolFiles/CSG_Screwdriver_Short_circular_flathead_stainlesssteel_shaft_titanium_tip.vol')

...
# Reciever
box = Box(Pnt(12,-1.5,-15.75), Pnt(19.9,1.5,-0.75))
box = box.Rotate(Axis((12,0,0), Y), -10)
# Barrel
cyl = Cylinder(Pnt(-16,0,0), X, r=2, h=36)
cyl_inside = Cylinder(Pnt(-16,0,0), X, r=1, h=34)
# Barrel-extra
barrel_ex = Box(Pnt(-16,-1.5,-0.5),(20,-2.5,0.5))
...
#Save the mesh
# print("save mesh")
nmesh.Save(r'VolFiles/OCC_Gun_nonsym_long_rotated_handle_10deg.vol')

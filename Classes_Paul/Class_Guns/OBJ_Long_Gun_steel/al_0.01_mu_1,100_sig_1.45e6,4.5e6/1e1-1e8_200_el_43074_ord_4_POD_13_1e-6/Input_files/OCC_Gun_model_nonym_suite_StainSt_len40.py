...
# Barrel
cyl = Cylinder(Pnt(0,0,0), X, r=2, h=40)
cyl_inside = Cylinder(Pnt(0,0,0), X, r=1, h=38)
# Barrel-extra
barrel_ex = Box(Pnt(0,-1.5,-0.5),(40,-2.5,0.5))
...
#Save the mesh
print("save mesh")
nmesh.Save(r'VolFiles/OCC_Gun_model_nonym_suite_StainSt_len40.vol')

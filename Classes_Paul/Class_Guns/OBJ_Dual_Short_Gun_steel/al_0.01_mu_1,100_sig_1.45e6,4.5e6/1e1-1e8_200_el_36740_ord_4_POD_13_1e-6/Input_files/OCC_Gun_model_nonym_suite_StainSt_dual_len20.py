...
# Barrel 1
cyl1 = Cylinder(Pnt(0,-1.25,0), X, r=2, h=20)
cyl1_inside = Cylinder(Pnt(0,-1.25,0), X, r=1, h=18)
cyl2 = Cylinder(Pnt(0,1.25,0), X, r=2, h=20)
cyl2_inside = Cylinder(Pnt(0,1.25,0), X, r=1, h=18)

# Barrel-extra
barrel_ex = Box(Pnt(0,-2.75,-0.5),(20,-3.75,0.5))
...
#Save the mesh
print("save mesh")
nmesh.Save(r'VolFiles/OCC_Gun_model_nonym_suite_StainSt_dual_len20.vol')

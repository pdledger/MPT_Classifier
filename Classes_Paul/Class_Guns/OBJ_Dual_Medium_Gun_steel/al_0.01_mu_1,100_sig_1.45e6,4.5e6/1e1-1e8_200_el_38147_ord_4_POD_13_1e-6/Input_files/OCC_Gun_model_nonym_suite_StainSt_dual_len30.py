...
sigma = [4.5e6, 1.45e6]
mur = [100, 1]# reduced mU-r for testing was [100,1]
alpha =0.01
...
# Reciever
box = Box(Pnt(22,-0.5,-15.75), Pnt(30,0.5,-0.75))
# Barrel 1
cyl1 = Cylinder(Pnt(0,-1.25,0), X, r=2, h=30)
cyl1_inside = Cylinder(Pnt(0,-1.25,0), X, r=1, h=28)
cyl2 = Cylinder(Pnt(0,1.25,0), X, r=2, h=30)
cyl2_inside = Cylinder(Pnt(0,1.25,0), X, r=1, h=28)

# Barrel-extra
barrel_ex = Box(Pnt(0,-2.75,-0.5),(30,-3.75,0.5))
...
#Save the mesh
print("save mesh")
nmesh.Save(r'VolFiles/OCC_Gun_model_nonym_suite_StainSt_dual_len30.vol')

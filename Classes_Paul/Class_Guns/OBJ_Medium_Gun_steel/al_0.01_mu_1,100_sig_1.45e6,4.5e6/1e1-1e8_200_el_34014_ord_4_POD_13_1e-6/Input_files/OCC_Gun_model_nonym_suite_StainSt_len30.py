...
# Barrel
cyl = Cylinder(Pnt(0,0,0), X, r=2, h=30)
cyl_inside = Cylinder(Pnt(0,0,0), X, r=1, h=28)
# Barrel-extra
barrel_ex = Box(Pnt(0,-1.5,-0.5),(30,-2.5,0.5))
...
#Save the mesh
print("save mesh")
nmesh.Save(r'VolFiles/OCC_Gun_model_nonym_suite_StainSt_len30.vol')

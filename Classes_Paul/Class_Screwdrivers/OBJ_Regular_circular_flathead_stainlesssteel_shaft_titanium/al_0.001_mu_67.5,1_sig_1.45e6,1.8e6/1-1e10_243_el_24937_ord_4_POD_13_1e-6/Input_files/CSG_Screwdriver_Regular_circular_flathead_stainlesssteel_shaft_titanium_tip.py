...
material_name = ['stainless_steel', 'titanium']
sigma = [1.450E+06, 1.798E+06]
mur = [67.5, 1]
alpha = 0.001
...
nmesh.Save(r'VolFiles/CSG_Screwdriver_Regular_circular_flathead_stainlesssteel_shaft_titanium_tip.vol')

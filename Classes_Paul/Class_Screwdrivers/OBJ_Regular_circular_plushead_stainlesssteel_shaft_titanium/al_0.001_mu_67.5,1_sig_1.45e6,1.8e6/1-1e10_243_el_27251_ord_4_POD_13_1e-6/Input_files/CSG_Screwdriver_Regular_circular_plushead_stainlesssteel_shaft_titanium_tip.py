...
geo = CSGeometry(r'GeoFiles/Regular_circular_plushead.geo')
...
nmesh.Save(r'VolFiles/CSG_Screwdriver_Regular_circular_plushead_stainlesssteel_shaft_titanium_tip.vol')

...
geo = CSGeometry(r'GeoFiles/Long_circular_plushead.geo')
...
nmesh.Save(r'VolFiles/CSG_Screwdriver_Long_circular_plushead_stainlesssteel_shaft_titanium_tip.vol')

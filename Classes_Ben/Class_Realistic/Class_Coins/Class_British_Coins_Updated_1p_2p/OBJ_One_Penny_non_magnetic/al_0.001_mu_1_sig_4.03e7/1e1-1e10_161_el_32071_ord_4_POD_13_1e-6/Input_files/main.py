...
def main(h='coarse', order=2, curve_degree=5, start_stop=(), alpha='', geometry='default', frequency_array='default', use_OCC=False,
         use_POD=False, use_parallel=True, use_iterative_POD=False, cpus='default', N_POD_points='default', Order_L2=0):
    """
...
if __name__ == '__main__':
    ret1 = main(geometry='One_p_pre.geo', order=4, use_POD=True, start_stop=(1,10,161))
    ret2 = main(geometry='Two_p_pre.geo', order=4, use_POD=True, start_stop=(1,10,161))

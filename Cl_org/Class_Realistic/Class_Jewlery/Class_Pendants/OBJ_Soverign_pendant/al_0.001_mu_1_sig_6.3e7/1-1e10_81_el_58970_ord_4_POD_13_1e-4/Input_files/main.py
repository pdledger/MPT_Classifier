...
#Geometry
def Sim_Runner(Geo,MUs,SIGs):
    #(string) Name of the .geo file to be used in the frequency sweep i.e.
    # "sphere.geo"
    
    #First remove the identifier at the end fo the Geometry
    Geo = Geo.rsplit('_',1)[0]
    ...
    #Try statement to worki out if it runs
    #try:
    ...
    Materials,mur,sig,inorout = VolMatUpdater(Geometry,OldMesh,MUs,SIGs)

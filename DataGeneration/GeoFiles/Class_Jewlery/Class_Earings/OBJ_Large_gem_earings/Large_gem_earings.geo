...
#Create the left earing
solid left_gem_cuff = (plane(0,0,1;0,0,1)
	and ellipsoid(7,-100,0;7,0,0;0,6,0;0,0,4)
	and not ellipsoid(7,-100,0;6,0,0;0,5,0;0,0,3))
	or torus(-0.75,-100,0;0,0,1;1;0.35);

solid left_hoop = ellipticcylinder(-2.75,-100,0;1.5,0,0;0,0,1)
	and plane(0,-100.5,0;0,-1,0)
	and plane(0,-99.5,0;0,1,0)
	and not ellipticcylinder(-2.75,-100,0;1,0,0;0,0,0.5);

solid left_loop_protect = plane(-2.75,0,0;1,0,0)
	and plane(0,-100.5,0;0,-1,0)
	and plane(0,-99.5,0;0,1,0)
	and not ellipticcylinder(-2.75,-100,0;1,0,0;0,0,0.5);

solid left_loop_front = left_loop_protect
	and plane(0,0,-4;0,0,-1)
	and ellipticcylinder(-2.75,0,-4;10,0,0;0,0,4.9)
	and not ellipticcylinder(-5.75,0,-4;6.5,0,0;0,0,3.9);

solid left_loop_back = plane(0,0,-4;0,0,1)
	and plane(-2.75,0,0;1,0,0)
	and plane(0,-100.5,0;0,-1,0)
	and plane(0,-99.5,0;0,1,0)
	and ellipticcylinder(-2.75,0,-4;10,0,0;0,0,4.9)
...
solid left_earing = left_gem_cuff or left_hoop or left_loop_front or left_loop_back;
solid earings = right_earing or left_earing-maxh=1;

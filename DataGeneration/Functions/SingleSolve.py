...
#This section solves the Theta1 problem and saves the solution vectors
    ...
    if VTK == True:
        ...
        Sols.append(E2Mag)
        Sols.append(E3Mag)
        savename = "Results/vtk_output/"+Object[:-4].replace('GeoFiles/','').rsplit('/',1)[0]+"/om_"+FtoS(Omega)+"/"
        if Refine == True:
            vtk = VTKOutput(ma=mesh, coefs=Sols, names = ["Object","E1real","E1imag","E2real","E2imag","E3real","E3imag","E1Mag","E2Mag","E3Mag"],filename=savename+Object[:-4].rsplit('/',1)[1],subdivision=3)
        else:
            vtk = VTKOutput(ma=mesh, coefs=Sols, names = ["Object","E1real","E1imag","E2real","E2imag","E3real","E3imag","E1Mag","E2Mag","E3Mag"],filename=savename+Object[:-4].rsplit('/',1)[1],subdivision=0)
        vtk.Do()
